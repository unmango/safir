// <auto-generated>
//    https://github.com/MahApps/MahApps.Metro/blob/develop/src/MahApps.Metro/MahApps.Metro.Shared/Behaviours/BorderlessWindowBehavior.cs
// </auto-generated>

namespace Safir.ControlLibrary.Behaviours
{
    using System;
    using System.Linq;
    ...
    using Safir.ControlLibrary.Controls;
    using Safir.ControlLibrary.Native;
    ...
    public class BorderlessWindowBehavior : Behavior<Window>
    {
        ...
        protected override void OnAttached() {
            ...
            if (AssociatedObject is SafirWindow window) {
                //windowChrome.IgnoreTaskbarOnMaximize = window.IgnoreTaskbarOnMaximize;
                windowChrome.UseNoneWindowStyle = window.UseNoneWindowStyle;
                System.ComponentModel.DependencyPropertyDescriptor.FromProperty(SafirWindow.IgnoreTaskbarOnMaximizeProperty, typeof(SafirWindow))
                      .AddValueChanged(AssociatedObject, IgnoreTaskbarOnMaximizePropertyChangedCallback);
                System.ComponentModel.DependencyPropertyDescriptor.FromProperty(SafirWindow.UseNoneWindowStyleProperty, typeof(SafirWindow))
            ...
            AssociatedObject.LostFocus += (sender, args) => { topmostHack(); };
            AssociatedObject.Deactivated += (sender, args) => { topmostHack(); };
        ...
        private void UseNoneWindowStylePropertyChangedCallback(object sender, EventArgs e) {
            if (sender is SafirWindow SafirWindow && this.windowChrome != null) {
                if (!Equals(windowChrome.UseNoneWindowStyle, SafirWindow.UseNoneWindowStyle)) {
                    windowChrome.UseNoneWindowStyle = SafirWindow.UseNoneWindowStyle;
        ...
        private void IgnoreTaskbarOnMaximizePropertyChangedCallback(object sender, EventArgs e) {
            if (sender is SafirWindow SafirWindow && this.windowChrome != null) {
                if (!Equals(windowChrome.IgnoreTaskbarOnMaximize, SafirWindow.IgnoreTaskbarOnMaximize)) {
                    ...
                    windowChrome.IgnoreTaskbarOnMaximize = SafirWindow.IgnoreTaskbarOnMaximize;
                    if (removed) {
        ...
        private bool _ModifyStyle(Standard.WS removeStyle, Standard.WS addStyle) {
            ...
            var intPtr = Standard.NativeMethods.GetWindowLongPtr(handle, Standard.GWL.STYLE);
        ...
        private void Cleanup() {
            if (!this.isCleanedUp) {
                ...
                // clean up events
                if (this.AssociatedObject is SafirWindow) {
                    System.ComponentModel.DependencyPropertyDescriptor.FromProperty(SafirWindow.IgnoreTaskbarOnMaximizeProperty, typeof(SafirWindow))
        ...
        private void HandleMaximize() {
            ...
            var SafirWindow = this.AssociatedObject as SafirWindow;
            //var enableDWMDropShadow = this.EnableDWMDropShadow;
            //if (SafirWindow != null) {
            //    enableDWMDropShadow = SafirWindow.GlowBrush == null && (SafirWindow.EnableDWMDropShadow || this.EnableDWMDropShadow);
            //}
            ...
            if (this.AssociatedObject.WindowState == WindowState.Maximized) {
                ...
                var ignoreTaskBar = SafirWindow != null && SafirWindow.IgnoreTaskbarOnMaximize;
                if (this.handle != IntPtr.Zero) {
        ...
        private void AssociatedObject_Loaded(object sender, RoutedEventArgs e) {
            var window = sender as SafirWindow;
            if (window == null) {
                return;
            }
