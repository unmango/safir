...
namespace Safir.Controls
{
    ...
    public class WindowControlButtons : ContentControl
    {
        ...
        // TODO: Needs notifyPropertyChanged. Check to see if Fody takes care of it. If not, try to get caliburn.micro to work with it
